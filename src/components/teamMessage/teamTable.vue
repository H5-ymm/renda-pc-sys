   ...
   <div>
      <el-form :model="formParams" class="demo-form-inline">
        ...
        <el-form-item class="hanble-btn">
          <el-button type="primary" @click="handleTeam('check')" v-if="tableType=='all'" class="select-btn">审核</el-button>
      ...
      >
        ...
        <el-table-column label="职称" prop="member_count" v-if="tableType=='personal'" align="center" width="150"></el-table-column>
        <el-table-column label="拥有简历" prop="member_count" v-if="tableType=='personal'" align="center" width="150"></el-table-column>
        <el-table-column label="团队人员" prop="member_count" v-if="tableType=='all'" align="center" width="150"></el-table-column>
        <el-table-column label="状态" align="center" width="100">
          <template slot-scope="props">
            <span>{{ props.row.status === 1 ? '待审核': props.row.status === 2 ? '已通过': '未通过'}}</span>
          </template>
        </el-table-column>
        <el-table-column label="操作" align="center" class="table-button-box">
          <template slot-scope="scope">
            <div class="table-button-box">
              <el-button @click="handleTeam('check',scope.row)" type="text" size="small" v-if="tableType=='all'">审核</el-button>
    ...
    ></confirmDialog>
    <memberInfo
      :dialogTableVisible="dialogInfoVisible"
      :uid="uid"
    ></memberInfo>
    </div>
</template>
...
import { getTeamList, checkTeamSave,delTeam ,delUser} from '../../api/team'
export default {
   components: {
    Log,
    confirmDialog,
